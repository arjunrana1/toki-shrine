...
See PRD §7 and §17's 19 September wizard amendment and the [closed implementation task](../../coordination/tasks/TS-block-wizard-redesign/TASK.md). Five screens: contents, name, method, disable difficulty, review. Details is an optional sheet inside step 3. Typing 100..200/10, default 150; pause wait 60..300/5 seconds, default 60; pause 5..100/5 minutes, default 15. Disable inherits method: 220/350/700 characters or 3/6/12 minutes, middle preselected. Sheet dismissal retains draft only; summaries update immediately. Preserve edit cancellation, direct entry, draft restoration and save guards. Typo highlighting remains unconditional. Closure evidence is separated in the task's REVIEW and OWNER-CHECKS; challenge execution remains Phase 5.
