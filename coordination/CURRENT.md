...
- **Base:** the committed Phase 3/wizard closure at repository HEAD when this handoff is delivered. The Phase 4 implementer must record `git rev-parse HEAD` before editing, preserve unrelated unstaged documentation/design/branding/report work, and touch only task-owned files.
